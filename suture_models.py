...
needleVolume_fileName="C:\sofa\src\VirtualSkinV4\mesh\suture_needle.obj"
...
def sphere(parentNode=None, name=None, translation=[0.0, 0.0, 0.0], scale3d=[0.0, 0.0, 0.0], color=[0.0, 0.0, 0.0], SphereModelNumber=None):
    ...
    name=parentNode.addChild(name)
    name.addObject('MeshObjLoader', name='sphere', filename="C:\sofa\src\VirtualSkinV4\mesh\sphere.obj") 
...
def ring(parentNode=None, name=None, translation=[0, 0, 0], scale3d=[0.0, 0.0, 0.0],  RingModelNumber=None): 
    ...
    name.addObject('UncoupledConstraintCorrection')
    name.addObject('BoxROI', name='boxROI', box=[translation[0]-1,translation[1]-1,translation[2]-3,translation[0]+1,translation[1]+1,translation[2]], drawBoxes='false', computeTriangles='true')
    name.addObject('RestShapeSpringsForceField', name='rest', points='@boxROI.indices', stiffness='1e12', angularStiffness='1e12')
    
    Visu=name.addChild('Visu')
    Visu.addObject('MeshObjLoader' ,name="meshLoader_3", filename="mesh/torus.obj", scale="0.6", handleSeams="1" )
...
side=0, sphere1Box=[0.0, 0.0, 0.0], sphere2Box=[0.0, 0.0, 0.0],sphere3Box=[0.0, 0.0, 0.0],sphere4Box=[0.0, 0.0, 0.0]):
    ...
    name.addObject('MeshGmshLoader', name='volumeLoader', filename="C:\sofa\src\VirtualSkinV4\mesh\skin_volume_403020_05", scale3d=scale3d)
    ...
    boxROI=name.addObject('BoxROI', name='boxROI', box=fixingBox, drawBoxes='false', computeTriangles='true')
    name.addObject('RestShapeSpringsForceField', name='rest', points='@boxROI.indices', stiffness='1e12', angularStiffness='1e12')
    
    if sphere1Box!=[0.0, 0.0, 0.0] or sphere3Box!=[0.0, 0.0, 0.0]:
        if side==0: 
            name.addObject('BoxROI', name='sphere1Box', box=sphere1Box, drawBoxes='false', computeTriangles='true')
            name.addObject('BoxROI', name='sphere2Box', box=sphere2Box, drawBoxes='false', computeTriangles='true')
            ...
            name.addObject('BoxROI', name='sphere3Box', box=sphere3Box, drawBoxes='false', computeTriangles='true')
            name.addObject('BoxROI', name='sphere4Box', box=sphere4Box, drawBoxes='false', computeTriangles='true')  
...
def StraightNeedle(parentNode=None, name=None, scale3d=[0.03, 0.2, 0.2], color=[0.0, 0.0, 0.0],     #scale3d=[0.06, 0.5, 0.5]
position="@GeomagicDevice.positionDevice", external_rest_shape='@../Omni/DOFs', # position and external_rest_shape are set by default for the single station case 
monitor=False, file1=None, file2=None, file3=None): 
    ...
    Visu=name.addChild('Visu')
    Visu.addObject('MeshObjLoader' ,name="meshLoader_3", filename="C:\sofa\src\VirtualSkinV4\mesh\straight_needle.obj", scale3d=scale3d, handleSeams="1" , translation=[0, 0, 10] , rotation=[0, 90, 0])
    Visu.addObject('OglModel',name="Visual", src='@meshLoader_3',  color="0 0.5 0.796", translation=[0,0,-11])#, rotation=[90, 0, 0])#, dz=3)
    Visu.addObject('RigidMapping' ,input="@..", output="@Visual")
    
    Surf=name.addChild('Surf')
    Surf.addObject('MeshObjLoader' ,filename="C:\sofa\src\VirtualSkinV4\mesh\straight_needle.obj" ,scale3d=scale3d, name="loader", translation=[0, 0, 10] , rotation=[0, 90, 0])
    Surf.addObject('MeshTopology' ,src="@loader")
